...
class ModerationResult(BaseModel):
    ...
    contains_pii: bool = Field(
        description="Whether any personally-identifiable information (PII) such as names, addresses, phone numbers was detected",
        default=False,
    )
    ...
    def is_flagged(self) -> bool:
        return any(
            flag
            for flag in self.model_dump(exclude={"is_flagged"}).values()
