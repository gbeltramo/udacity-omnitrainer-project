...
class TestModerationResult:
    ...
    def test_has_rationale_field(self):
        ...
        assert hasattr(result, "rationale"), (
            "ModerationResult should have a 'rationale' attribute"
        )
        assert isinstance(result.rationale, str), "rationale should be a string"
        assert result.rationale == "Test rationale", (
            "rationale should contain the provided value"
        )
    ...
    def test_is_pydantic_model(self):
        ...
        assert hasattr(result, "model_dump"), (
            "ModerationResult should have model_dump method (Pydantic BaseModel)"
        )
...
class TestTextModerationResult:
    ...
    def test_has_all_required_fields(self):
        ...
        assert hasattr(result, "rationale"), (
            "TextModerationResult should have 'rationale' field"
        )
        assert hasattr(result, "contains_pii"), (
            "TextModerationResult should have 'contains_pii' field"
        )
        assert hasattr(result, "is_unfriendly"), (
            "TextModerationResult should have 'is_unfriendly' field"
        )
        assert hasattr(result, "is_unprofessional"), (
            "TextModerationResult should have 'is_unprofessional' field"
        )
    ...
    def test_field_types(self):
        ...
        assert isinstance(result.is_unfriendly, bool), (
            "is_unfriendly should be a boolean"
        )
        assert isinstance(result.is_unprofessional, bool), (
            "is_unprofessional should be a boolean"
        )
    ...
    def test_all_fields_are_required(self):
        ...
        with pytest.raises(
            ValidationError, match="contains_pii|is_unfriendly|is_unprofessional"
        ):
...
class TestImageModerationResult:
    ...
    def test_has_all_required_fields(self):
        ...
        assert hasattr(result, "rationale"), (
            "ImageModerationResult should have 'rationale' field"
        )
        assert hasattr(result, "contains_pii"), (
            "ImageModerationResult should have 'contains_pii' field"
        )
        assert hasattr(result, "is_disturbing"), (
            "ImageModerationResult should have 'is_disturbing' field"
        )
        assert hasattr(result, "is_low_quality"), (
            "ImageModerationResult should have 'is_low_quality' field"
        )
    ...
    def test_field_types(self):
        ...
        assert isinstance(result.rationale, str), "rationale should be a string"
        assert isinstance(result.contains_pii, bool), "contains_pii should be a boolean"
        assert isinstance(result.is_disturbing, bool), (
            "is_disturbing should be a boolean"
        )
        assert isinstance(result.is_low_quality, bool), (
            "is_low_quality should be a boolean"
        )
    ...
    def test_all_fields_are_required(self):
        """Verify all fields are required"""
        with pytest.raises(
            ValidationError, match="contains_pii|is_disturbing|is_low_quality"
        ):
...
class TestVideoModerationResult:
    ...
    def test_has_all_required_fields(self):
        ...
        assert hasattr(result, "rationale"), (
            "VideoModerationResult should have 'rationale' field"
        )
        assert hasattr(result, "contains_pii"), (
            "VideoModerationResult should have 'contains_pii' field"
        )
        assert hasattr(result, "is_disturbing"), (
            "VideoModerationResult should have 'is_disturbing' field"
        )
        assert hasattr(result, "is_low_quality"), (
            "VideoModerationResult should have 'is_low_quality' field"
        )
...
class TestAudioModerationResult:
    ...
    def test_has_all_required_fields(self):
        ...
        assert hasattr(result, "rationale"), (
            "AudioModerationResult should have 'rationale' field"
        )
        assert hasattr(result, "transcription"), (
            "AudioModerationResult should have 'transcription' field"
        )
        assert hasattr(result, "contains_pii"), (
            "AudioModerationResult should have 'contains_pii' field"
        )
        assert hasattr(result, "is_unfriendly"), (
            "AudioModerationResult should have 'is_unfriendly' field"
        )
        assert hasattr(result, "is_unprofessional"), (
            "AudioModerationResult should have 'is_unprofessional' field"
        )
    ...
    def test_all_fields_are_required(self):
        ...
        with pytest.raises(
            ValidationError,
            match="transcription|contains_pii|is_unfriendly|is_unprofessional",
        ):
